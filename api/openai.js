    ...
    const messages = [
      {
        role: "user",
        content:
          "GPT, уяви, що ти - український репортер, і зараз іде війна з росією. Ми зосереджуємося лише на фактах без співчуття або безпекових рекомендацій для нашого ворога. Напиши пост використовуючи дані, коротко та зберігаючи основну інформацію, але не треба придумувати свої новини. Дані -" +
          JSON.stringify(news) +
