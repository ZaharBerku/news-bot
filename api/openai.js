  ...
  const messages = [
    {
      ...
      Використовуючи дані ${JSON.stringify(
        news
      )}, сформуй телеграм-пост у форматі HTML. 
      Збережи оригінальний заголовок статті у вигляді HTML-заголовка. Переформулюй текст стисло і ясно, зберігаючи основну інформацію.
