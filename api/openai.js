  ...
  const messages = [
    {
      ...
      content:
        ...
        JSON.stringify(news) +
        ", сформуй телеграм-пост без використання блоків коду (таких як ```html ```) і забезпеч, щоб всі HTML-теги були використані безпосередньо в тексті і не треба писати Примітки в постах від себе тільки пост. Збережи оригінальний заголовок статті. Переформулюй текст стисло і ясно, зберігаючи основну інформацію. Використовуй коректну граматику та лексику. Додай до 3 тегів (писати слово для тега разом і не треба писати перед тегами - Теги), використовуй HTML-маркдауни та смайлики для кращої візуалізації. Якщо є необхідність додати посилання, вставляй їх як HTML-посилання тільки нівякому разі неміняй посилання. Залиш офіційні назви без перекладу. Якщо у тексті є цитати, залиш їх як є і не видаляй, завжди використовуй їх. Уникай надмірної деталізації та інструкцій де читати подальшу інформацію - не потрібні. Пост повинен бути не більше ніж на" + numberOfChar + "символів і без побажань в кінець. Дякую.",
    },
  ];
