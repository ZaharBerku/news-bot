  ...
  const messages = [
    {
      ...
      content:
        ...
        JSON.stringify(news) +
        ", сформуй телеграм-пост у форматі Markdown. Збережи оригінальний заголовок статті, використовуючи Markdown-форматування для заголовків. Переформулюй текст стисло і ясно, зберігаючи основну інформацію. Використовуй коректну граматику та лексику. Додай до 3 тегів, використовуючи Markdown для тегів, та смайлики для кращої візуалізації. Не додавай жодних посилань. Залиш офіційні назви без перекладу. Якщо у тексті є цитати, залиш їх як є і не видаляй, завжди використовуй їх. Уникай надмірної деталізації та інструкцій де читати подальшу інформацію - не потрібні. Пост повинен бути не більше ніж на " +
        numberOfChar +
        " символів і без побажань в кінеці. Завжидни пиши росія і буль яке слово пов'язоно з цим словом - з маленької букви. Дякую.",
    },
  ];
