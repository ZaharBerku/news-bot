  ...
  const messages = [
    {
      ...
      content:
        ...
        "Забезпеч, щоб всі HTML-теги були використані безпосередньо в тексті. Збережи оригінальний заголовку статті у вигляді HTML-заголовка. Переформулюй текст стисло і ясно, зберігаючи основну інформацію і не треба писати Примітки в постах від себе тільки пост. Використовуй до 3 тегів без виділення словом 'Теги', використовуй HTML-маркдауни та смайлики для кращої візуалізації. Не додавай жодних посилань. Залиш офіційні назви без перекладу. Якщо у тексті є цитати, залиш їх як є, завжди використовуй їх. Уникай надмірної деталізації та інструкцій де читати подальшу інформацію - не потрібні. Пост повинен бути не більше ніж на " +
        numberOfChar +
